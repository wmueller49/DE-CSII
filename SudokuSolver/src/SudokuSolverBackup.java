...
public class SudokuSolver{	
   ...
   public SudokuSolver(ArrayList<ArrayList<SudokuSquare>> startBoard) {
      ...
      JFrame window;
      JPanel container, sudokuPanel, buttonPanel;  
   
      window = new JFrame("Sudoku");
      window.setSize(new Dimension(WIDTH, HEIGHT));
      window.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
   	
      sudokuPanel = createSudokuPanel(startBoard);
   ...
   public JPanel createSudokuPanel(ArrayList<ArrayList<SudokuSquare>> startBoard) {
